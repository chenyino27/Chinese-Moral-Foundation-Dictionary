...
def main():
    keywords=[]
    with open('five_dimension/virtue1/authority_virtue.csv','r',encoding='utf-8-sig') as f:
        lines=f.readlines()
        for line in lines:
            words=line.replace('\n','').split(',')
            keywords.append(words[1])
    for keyword in keywords:
        cookies='SINAGLOBAL=4602739008889.936.1655366773548; ULV=1655366773552:1:1:1:4602739008889.936.1655366773548:; SSOLoginState=1656999406; XSRF-TOKEN=3bc3BuTDOQPq9B8RYzbzEzGZ; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WWMbTxkCSkANcqGhaSNNxSK5JpX5KMhUgL.FoMXSK2NSo.c1hn2dJLoIEXLxKBLBonL1KnLxKBLBonL1KnLxK-L1hMLB-qLxKML1K2L1-qLxKML1K5LBoet; ALF=1688881359; SCF=AmuJXt01004aAYo_MkA0heebYtQAv89LIDBtiJBsMVyr9MluC9BBd4YLqVzdFZIL_HVcc7JYCgyCqc10_7L1cLE.; SUB=_2A25PzWUADeRhGeFK7lMW9ifKwzSIHXVsu9HIrDV8PUNbmtB-LVPRkW9NQ1rnVzmbXBZX1ezZsYOmD4EbAXoza50F; WBPSESS=PSwrKvME8CLNuDbjZ94SwKONe3Fry9hO92EJuc1VB01HFrqX0nH1Kr3Oqmaz55sF8tbkWjAls4KtipADKYlbUGvKN4K0aD2C2cHbGb_zgvdvIlqt3WoNVhPNDoMpCNFF1qg602PJEmcCly_EGo80IA=='
